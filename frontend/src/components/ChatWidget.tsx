  ...
  return (
    <div className="fixed bottom-5 right-5 z-40">
      ...
      >
        ...
        {unread > 0 && !open && (
          <span className="absolute -right-0.5 -top-0.5 flex h-5 min-w-[1.25rem] items-center justify-center rounded-full bg-white px-1 text-[11px] font-bold text-brand-700 ring-2 ring-brand-600">
            {unread > 9 ? '9+' : unread}
          </span>
        )}
      </button>
